...
public class LayeringCacheManager implements CacheManager {
    ...
    private final RedisOperations redisOperationsSub;
    ...
    // 新增构造
    public LayeringCacheManager(RedisOperations redisOperations,RedisOperations redisOperationsSub,RedisCacheConfiguration redisCacheConfiguration,RedisCacheWriter redisCacheWriter) {
        this(redisOperations,redisOperationsSub, Collections.<String>emptyList(),false,redisCacheConfiguration,redisCacheWriter);
    }
    // 新增构造
    public LayeringCacheManager(RedisOperations redisOperations,RedisOperations redisOperationsSub, Collection<String> cacheNames, boolean allowNullValues,RedisCacheConfiguration redisCacheConfiguration,RedisCacheWriter redisCacheWriter) {
...
//    }
    ...
    protected Cache createCache(String name) {
        return new LayeringCache(name,null, redisOperations,redisOperationsSub,redisCacheConfiguration,redisCacheWriter,
